...
class TimeSlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_slot" do
    assert_difference('TimeSlot.count') do
      post time_slots_url, params: { time_slot: { date: @time_slot.date, day: @time_slot.day, time: @time_slot.time } }, as: :json
    end
  ...
  test "should update time_slot" do
    patch time_slot_url(@time_slot), params: { time_slot: { date: @time_slot.date, day: @time_slot.day, time: @time_slot.time } }, as: :json
    assert_response 200
  end
