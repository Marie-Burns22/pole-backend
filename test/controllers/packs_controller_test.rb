...
class PacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pack" do
    assert_difference('Pack.count') do
      post packs_url, params: { pack: { name: @pack.name, price: @pack.price, quantity: @pack.quantity } }, as: :json
    end
  ...
  test "should update pack" do
    patch pack_url(@pack), params: { pack: { name: @pack.name, price: @pack.price, quantity: @pack.quantity } }, as: :json
    assert_response 200
  end
